// media_opus.h - Thin wrapper for libopus with simple API
...
// Opaque handles
typedef uint64_t media_opus_encoder_t;
typedef uint64_t media_opus_decoder_t;

// Applications
#define MEDIA_OPUS_APPLICATION_VOIP          2048
#define MEDIA_OPUS_APPLICATION_AUDIO         2049
#define MEDIA_OPUS_APPLICATION_LOWDELAY      2051

// Error codes
#define MEDIA_OPUS_OK              0
#define MEDIA_OPUS_ERROR          -1
#define MEDIA_OPUS_ERROR_NOMEM    -2
#define MEDIA_OPUS_ERROR_INVALID  -3
#define MEDIA_OPUS_ERROR_CODEC    -4
...
// application: MEDIA_OPUS_APPLICATION_VOIP, AUDIO, or LOWDELAY
