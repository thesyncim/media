// stream_h264.h - Thin wrapper for x264 with simple API
// This wrapper exposes only primitives, no complex structs.
// Use with purego for Go bindings.

#ifndef STREAM_H264_H
#define STREAM_H264_H
...
// Opaque handles
typedef uint64_t stream_h264_encoder_t;
typedef uint64_t stream_h264_decoder_t;

// Profiles
#define STREAM_H264_PROFILE_BASELINE     66
#define STREAM_H264_PROFILE_MAIN         77
#define STREAM_H264_PROFILE_HIGH         100
#define STREAM_H264_PROFILE_CONSTRAINED_BASELINE 578  // 66 | (1<<9)

// Frame types
#define STREAM_H264_FRAME_I      0
#define STREAM_H264_FRAME_P      1
#define STREAM_H264_FRAME_B      2
#define STREAM_H264_FRAME_IDR    3

// NAL unit types
#define STREAM_H264_NAL_SLICE           1
#define STREAM_H264_NAL_IDR             5
#define STREAM_H264_NAL_SEI             6
#define STREAM_H264_NAL_SPS             7
#define STREAM_H264_NAL_PPS             8

// Error codes
#define STREAM_H264_OK              0
#define STREAM_H264_ERROR          -1
#define STREAM_H264_ERROR_NOMEM    -2
#define STREAM_H264_ERROR_INVALID  -3
#define STREAM_H264_ERROR_CODEC    -4
...
stream_h264_encoder_t stream_h264_encoder_create(
    ...
    int fps,
    int bitrate_kbps,
    int profile,        // STREAM_H264_PROFILE_*
    int threads         // 0 = auto
);
...
int stream_h264_encoder_encode(
    ...
    int* out_frame_type,    // receives STREAM_H264_FRAME_*
...
void stream_h264_decoder_get_dimensions(
    stream_h264_decoder_t decoder,
    int* width,
    int* height
);
